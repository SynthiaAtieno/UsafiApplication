...
public class WorkerRgistration extends AppCompatActivity {

    private TextView backtv;
    CircleImageView profileImage;
    private TextInputEditText registerfullname, registeremail, registerphone, registerpassword, registeridNo, workPref;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_worker_rgistration);
        ...
        workPref = findViewById(R.id.registerInterest);
        ...
        register_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final String interest = workPref.getText().toString().trim();
                ...
                if (TextUtils.isEmpty(interest)) {
                    workPref.setError("Preference is Required");
                    return;
                }
              /*  if (bloodgroup.equals("Select Your Blood Group")) {
                    Toast.makeText(WorkerRgistration.this, "Please select your blood group", Toast.LENGTH_SHORT).show();
                    return;
                } */else {
                                        ...
                                        userDatabaseRef.updateChildren(userInfo).addOnCompleteListener(
                                                new OnCompleteListener() {
                                                    ...
                                                    public void onComplete(@NonNull Task task) {
                                                        if (task.isSuccessful()) {
                                                            Toast.makeText(WorkerRgistration.this, "Data set Successfully", Toast.LENGTH_SHORT).show();
                                                        } else {
                                                            Toast.makeText(WorkerRgistration.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                                        }
                                                        finish();
                                        ...
                                        if (resultUri != null) {
                                            ...
                                            uploadTask.addOnFailureListener(new OnFailureListener() {
                                                ...
                                                public void onFailure(@NonNull Exception e) {
                                                    Toast.makeText(WorkerRgistration.this, "Image Upload Failed", Toast.LENGTH_SHORT).show();
                                                }
                                            });
                                                        ...
                                                        result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                            ...
                                                            public void onSuccess(Uri uri) {
                                                                ...
                                                                userDatabaseRef.updateChildren(newImageMap).addOnCompleteListener(new OnCompleteListener() {
                                                                    ...
                                                                    public void onComplete(@NonNull Task task) {
                                                                        if (task.isSuccessful()) {
                                                                            Toast.makeText(WorkerRgistration.this, "Image added succsessfully", Toast.LENGTH_SHORT).show();
                                                                        } else {
                                                                            Toast.makeText(WorkerRgistration.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                                                        }
                                                                    }
                                            ...
                                            startActivity(new Intent(WorkerRgistration.this, MainActivity.class));
                                            finish();
                                            progressDialog.dismiss();
